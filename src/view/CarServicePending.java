...
public class CarServicePending extends JFrame {
    ...
    public static void main(String[] args) {
     ...
     public void refreshTable() throws ClassNotFoundException, SQLException {
    	    ...
    	    String sqlQuery ="SELECT ServiceID, CustID, CarModel, CarName,  Description,dateOfAppointment,  Status FROM car_service Where Status = 'PENDING'";
    ...
    public CarServicePending() throws ClassNotFoundException, SQLException {
        ...
        try (
            ...
            btnUpdate.addActionListener(new ActionListener() {
            	public void actionPerformed(ActionEvent e) {
            		...
            		staffController.updateTablePending(model);
            		try {
						refreshTable();
    		...
    		lblNewLabel1.setIcon(new ImageIcon(CarServicePending.class.getResource("/Images/car-service-key-features-A-1920x1080_tcm-3154-1323224.jpg")));
