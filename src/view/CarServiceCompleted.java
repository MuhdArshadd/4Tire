...
public class CarServiceCompleted extends JFrame {
    ...
    public static void main(String[] args) {
     ...
     public void refreshTable() throws ClassNotFoundException, SQLException {
 	    String[] header = { "ServiceID", "CustID", "CarModel", "CarName", "Description","Appointment Date",
  	           "Status"   };
        ...
        String sqlQuery = "SELECT ServiceID, CustID, CarModel, CarName,  Description,dateOfAppointment,  Status FROM car_service Where Status = 'COMPLETED'";
    ...
    public CarServiceCompleted() throws ClassNotFoundException, SQLException {
        ...
        try (
            ...
            JLabel lblNewLabel = new JLabel("Completed Repair And Service Jobs");
    		...
    		lblNewLabel1.setIcon(new ImageIcon(CarServiceCompleted.class.getResource("/Images/car-service-key-features-A-1920x1080_tcm-3154-1323224.jpg")));
